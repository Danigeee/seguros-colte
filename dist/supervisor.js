...
export const checkpointer = PostgresSaver.fromConnString(process.env.SUPABASE_DB_URL_CHAT);
/** Promesa que se resuelve cuando las tablas del checkpointer están listas. */
export const checkpointerReady = checkpointer
    .setup()
...
export function trackThreadActivity(_threadId) { }
export function cleanupInactiveThreads(_maxIdleMinutes) { return 0; }
